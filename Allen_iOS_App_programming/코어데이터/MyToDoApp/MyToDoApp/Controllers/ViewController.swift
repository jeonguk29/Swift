...
final class ViewController: UIViewController {
    ...
    // - 싱글톤으로 구현했음 MVC 패턴을 위해
    let toDoManager = CoreDataManager.shared
    
    override func viewDidLoad() {
        super.viewDidLoad()
        setupNaviBar() // 네비게이션 바를 셋업 하는 코드
        setupTableView() // 테이블 뷰를 셋업 하는 코드
    }
...
//    // 만약 셀을 선택했을때 다음 화면으로 간다면 didSelectRowAt 메서드를 통해 구현하고 세그웨이를 통해 전달하는 코드임
