...
final class MusicManager {
    ...
    // MusicManager 모델은 CoreDataManager, NetworkManager를 호출해 둘다 관리하는 주 모델임
    ...
    // 서버를 통해 음악 배열 가져오는 메서드
    func getMusicArraysFromAPI() -> [Music] {
        return musicArrays
    }
    
    // 코어 데이터를 통해 음악 배열 가져오는 메서드
    ...
    // - 너무 많은 로직 담지 않기 위해 메서드 별로 해당 메서드 호출하게 구현함
